package io.github.christophknabe.multex.core; //Jdk1_4StackTraceTest.java
...
public class Jdk1_4StackTraceTest extends MultexAssert {
	...
	@Test public void appendIrredundantTraceLines(){
		...
		assertEquals(
			"\tat io.github.christophknabe.multex.core.Jdk1_4StackTraceTest._createNullPointerException(Jdk1_4StackTraceTest.java:" + _npeLineNumber + ")"
			+ Util.lineSeparator
			+ "\tat io.github.christophknabe.multex.core.Jdk1_4StackTraceTest.<init>(Jdk1_4StackTraceTest.java:" + _lowExcLineNumber + ")"
			+ Util.lineSeparator
			,
			buf.toString()
		);
	...
	@Test public void msgPrintStackTrace(){
		...
		assertIsStart( ""
			...
			+ "\tat io.github.christophknabe.multex.core.Jdk1_4StackTraceTest.<init>(Jdk1_4StackTraceTest.java:" + _topExcLineNumber + ")"
