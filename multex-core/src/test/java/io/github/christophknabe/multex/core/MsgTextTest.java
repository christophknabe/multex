package io.github.christophknabe.multex.core;  //MsgTextTest.java

import java.util.Locale;
import java.util.ResourceBundle;

import io.github.christophknabe.multex.core.test.*;
...
private static final Exception _ex1 = new InitFailure(_ex2, "OOO", 9999);
...
@Test public void getMessageTextPattern_withResourceBundle(){
	final ResourceBundle germanBundle = new MsgTextDeResourceBundle();
	assertEquals("de", germanBundle.getLocale().toString());
	
	final String result1 = MsgText.getMessageTextPattern(_ex2, germanBundle);
	assertEquals(MsgTextDeResourceBundle.classCastExceptionText, result1);
...
@Test public void appendMessageLineWithDefaultLocale(){
	final ResourceBundle unspecBundle = new MsgTextResourceBundle();
...
@Test public void appendMessageLineWithClassCastExceptionWithoutDetailMessage(){
	final StringBuffer result = new StringBuffer();
	final Throwable ex = new ClassCastException();
	final ResourceBundle bundle = new MsgTextResourceBundle();
...
@Test public void appendMessageLineWithLocales(){
	final ResourceBundle englishBundle = new MsgTextEnResourceBundle();
	...
	result.setLength(0);
	MsgText.appendMessageLine(result, _ex1, new MsgTextDeResourceBundle());
