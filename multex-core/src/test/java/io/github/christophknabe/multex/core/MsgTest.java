package io.github.christophknabe.multex.core;  //MsgTest.java
...
import static io.github.christophknabe.multex.core.test.MultexAssert.assertLongStringEquals;
...
@Test public void printMessages_forNullException(){
    ...
    assertEquals(
        "null Throwable provided to io.github.christophknabe.multex.core.MsgText.appendMessageTree(...)", result
    ); 	
}
...
@Test public void printMessages_withRedundantMessageTexts(){
	...
	Msg.printMessages(buf, ex1);
    final String result = buf.toString();
	final String causeSeparator = _lineSeparator + Util.causeIndenter + MsgText.causeMarker;
	assertLongStringEquals(
...
public void printMessages_withDynamicDeResourcebundleText(){
	final MsgTextDeResourceBundle bundle = new MsgTextDeResourceBundle();
...
public void printMessages_withDynamicEnResourcebundleText(){
	final MsgTextEnResourceBundle bundle = new MsgTextEnResourceBundle();
