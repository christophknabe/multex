package io.github.christophknabe.multex.core;  //UtilTest.java
...
public class UtilTest extends MultexAssert {
	...
	@Test public void appendCompactStackTrace_ListExc(){
		...
		final String expected =
			...
			+ "\tat io.github.christophknabe.multex.core.UtilTest.<init>(UtilTest.java:" + _t1LineNumber + ")" + Util.lineSeparator
			+ "++" + t21.getClass().getName() + ": " + t21.getMessage() + Util.lineSeparator
			+ "\tat io.github.christophknabe.multex.core.UtilTest.<init>(UtilTest.java:" + _t21LineNumber + ")" + Util.lineSeparator
			+ Util.wasCausing + Util.lineSeparator
			+ "+" + t2.getClass().getName() + ": " + t2.getDefaultMessageTextPattern() + Util.lineSeparator
			+ "\tat io.github.christophknabe.multex.core.UtilTest.<init>(UtilTest.java:" + _t2LineNumber + ")" + Util.lineSeparator
			+ Util.wasCausing + Util.lineSeparator
			+ listExc.getClass().getName() + ": " + listExc.getDefaultMessageTextPattern() + Util.lineSeparator
			+ "\tat io.github.christophknabe.multex.core.UtilTest.<init>(UtilTest.java:" + _listExcLineNumber + ")" + Util.lineSeparator
			+ "\tat sun.reflect."			
		;
    ...
    @Test public void failingAppendIrredundantTraceLines(){
        ...
        assertEquals("io.github.christophknabe.multex.core.Util: No stack trace elements to append.", io_destination.toString());
    }
	...
	private static int compareVersions(String version1, String version2) {
		final Util.DottedVersion dottedVersion1 = new Util.DottedVersion(version1);
		final Util.DottedVersion dottedVersion2 = new Util.DottedVersion(version2);
