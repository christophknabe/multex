package io.github.christophknabe.multex.core; //ReflectionCauseGetter.java
...
/**Describes, how to get the causing exception of any non-MulTEx-exception
  ...
  This is now the default CauseGetter used by class {@link Util} to get the cause
  of a Throwable.<br>
  See {@link Util#setCauseGetter(CauseGetter)}
*/
