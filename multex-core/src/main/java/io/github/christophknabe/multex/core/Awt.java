package io.github.christophknabe.multex.core; //Awt.java
import java.awt.*;
import java.util.ResourceBundle;

//Change history:
//2026-07-28  Knabe  Changed to usage of Thread.setDefaultUncaughtExceptionHandler()
 ...
 * @see <a href="http://java.sun.com/developer/JDCTechTips/2003/tt1208.html">JDCTechTip</a>
 */
...
private static class Dialog {
  ...
  /**Creates a dialog window for reporting i_throwable with owner Window io_owner
    ...
    @see #report(Component, Throwable) 
  */
  private Dialog (
