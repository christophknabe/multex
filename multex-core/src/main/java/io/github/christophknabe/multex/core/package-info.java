/** <h1>MulTEx - the Multi-Tier Exception Handling Framework.</h1>
...
<p>The following naming conventions are used throughout the package {@code multex}.</p>
<ul>
...
<ol>
  ...
  <li>2005-01-13 Include private attributes of type Throwable into the
    {@link ReflectionCauseGetter} in order to get the cause for
...
<H2>Version history</H2><UL>
  ...
  <li>8.5 of 2022-05-11: Disallows creation of a non-static inner class as subclass of
    {@link Exc} or {@link Failure}. This avoids passing an outer this-reference
  ...
  <li>8.3 of 2011-11-08: Compiled and runs on Java 6. 
    Class {@link Util} has a new method {@link Util#setMaxRecursionDepth(int)}.
    The lower level utility method {@link Util#getCause(Throwable)}
    automatically uses the value configured by {@link Util#setMaxRecursionDepth(int)}.
    The limitation of the recursion depth became necessary with the {@code org.apache.derby.client.am.SqlException},
    whose method {@code getSQLException} wraps the {@code SqlException} into a {@code SQLException}.
  </li>
  <li>8.2 of 2009-10-22: {@code multex.ExceptionMessagesDoclet} always uses encoding ISO-8859-1 for appending
    message text patterns to the -out file, as Java .properties files always have to be encoded this way.
  </li>
  <li>8.1 of 2008-12-08: {@link MultexUtil#create(Class, Object...)} accepts exception class without cause or parameters.
  </li>
  <li>8.0 of 2008-01-09: New german paper about Central Exception Reporting.
    <br>Class {@link Exc} now unchecked.
    <br>Method {@link Exc#throwMe(Object...)} in class {@code Exc}
    <br>Method {@link Util#getOriginalException(Throwable)} called with a <b>null</b> argument returns <b>null</b> instead of throwing a {@code NullPointerException}
  </li>
  <LI>7.3 of 2007-09-18:
    ...
    <br>Static factory method for parameterized exceptions: {@link MultexUtil#create(Class, Object...)}.
    This allows a much simpler declaration of a parameterized exception, as you no longer have to declare a constructor in it.
    <br>The constructors for the parameterized exception classes {@link Exc}, {@link Failure}, and {@link AssertionFailure},
    and the method {@link Assertion#check} are now using an {@code Object...} parameter, instead of being overloaded with
    ...
    <br>The {@code multex.tool.ExceptionMessagesDoclet} now correctly converts also a multi-line main javadoc comment of each exception
    into the format for .properties files. It adds a backslash at the end of each line to be continued.
  </LI>
  <LI>7.2 of 2007-09-04:
    Optimized {@link ReflectionCauseGetter}.
    Does not use reflection on {@link MultexException}s.
    <br>This version is the last usable with Java 1.4.
    <br>This version is the first produced by Maven (2).
  </LI>
  <LI>7.1 of 2006-11-04
    Added {@code ExceptionMessagesDoclet}.
    You can use this doclet to extract the main comment of each Throwable into a .properties file as message text.
    <br>
    Added constructor {@link Failure#Failure(String)} without a cause.
  </LI>
  <LI>7 of 2006-05-11: Added parameter cause in constructors of class {@link Exc};
    Added method getCause() in interface {@link MultexException}.
    <br>Added list exception facility: All parameters of a {@link MultexException}, which are of type java.lang.Throwable,
      are reported by {@link Msg#printMessages}, thus resulting in a causal exception tree instead of an exception chain.
    <br>{@link Msg#printStackTrace} prints thus a redundancy-free stack trace of all exceptions,
      contained in the causal exception tree.
    <br>As the tree is symbolized by an indentation by multiple {@code +} signs,
  ...
  <LI>6a of 2005-04-14
    Added method {@code Awt.setAwtExceptionHandlerClass} to set a general exception handler,
  ...
  <LI>6 of 2005-01-13
      <br>Improvement: The methods in class {@link Msg}
      ...
      {@link ReflectionCauseGetter} instead of leaving this to
      ...
      {@link Failure} to the new class {@link Util}.
  </LI>
  <LI>5d of 2004-12-10:
  ...
  <LI>5c of 2004-11-05:
      <br>Bugfix: The methods in class {@link Msg}
      ...
      b) suppress reporting an object of the exact class Failure
         without any own info. See {@link Failure#Failure(Throwable)} shortly
  ...
  <LI>5b of 2004-05-11:
      <br>Bugfix: Method {@code Msg#printReport(StringBuffer, Throwable, ResourceBundle)}
      now passes its ResourceBundle to multex.Msg.printMessages(...).
      <br>Bug avoiding: Now {@link Awt} and {@link Swing} show the reporting dialog
      in the AWT event queue thread, instead of the callers thread.
      See http://java.sun.com/developer/JDCTechTips/2003/tt1208.html
      <br>Comfort: Method {@link Awt#countLines(String)} is now public.
  </LI>
  <LI>5a of 2003-11-25:
      <br>Bugfix: Report any exception with message text pattern, but without
      exception parameters or Throwable.getMessage() without
      {@code ": null"}.. Corresponding testcases added.
  </LI>
  <LI>5 of 2003-09-12:
      <br>Added class {@link Swing} for reporting into a Swing dialog
          with dynamic or static internationalization.
          Interface of class {@link Awt} simplified (incompatible change) and made
          uniform with Swing.
      <br>Added method {@link Util#getContainedException(java.lang.Throwable,java.lang.Class)}, originally to class Failure.
      ...
      by key {@link MsgText#causeMarker} instead of giving it as a separate
      ...
      See class description {@link Msg} (incompatible change).
  </LI>
  ...
  <LI>4  of 2003-05-22: With dynamic internationalization as for web servers.
      ...
      See {@link Msg#printMessages(StringBuffer,Throwable,java.util.ResourceBundle)}.
  </LI>
  ...
  <LI>2 of 2001-04-19:
    <UL>
      ...
      <LI>Now its possible to redefine the method checkClass() in order to
        ...
        descendants of {@link Exc} and {@link Failure}.
      </LI>
      <LI>class {@link Awt}: After showing the stack trace scrolls upwards in
  ...
  <LI>1c of 2000-02-27:
    <UL>
      <LI>Internationalization of message texts is now optional.
        ...
        {@code multex.MsgText.setInternationalization(true);}
      </LI>
    ...
    <UL>
      ...
      <LI>class multex.Failure:
        <UL>
          ...
          <LI>Added function
            {@code Throwable originalException(Throwable i_throwable)}
            to get the original exception, which is {@code i_throwable}
...
@author Christoph Knabe, TFH Berlin, 1999-2026 Copyrighted, but usable by GNU LGPL.
 */
