 ...
 * {@link Msg} or {@link Awt}, or {@link Swing}.
 * <br>
...
public class Util {
    ...
    */
    public static Throwable[] getCauses(final Throwable i_throwable){
    	//Count the causes:
    	int count = 0;
    ...
    */
    ...
    /**
     * Gets the default message text pattern from the 'multexException`.
     * @param multexException must not be null
     * @return its default message text pattern. First a text contained in the object,
     * helpwise the text contained in the Text annotation, in other cases null.
     */
    static String getDefaultMessageTextPattern(final MultexException multexException, final String fromObjectPattern){
        if(null == multexException){
            return null;
        }
        if (null != fromObjectPattern) {
            return fromObjectPattern;
        }
        final TextPattern annotation = multexException.getClass().getAnnotation(TextPattern.class);
        if(annotation==null){
            return null;
        }
...
*/
    ...
    */
    ...
    @TextPattern("Probably cycle in exception chain. Exceeding maximum causal recursion depth of {0}")
    ...
    */
    ...
    /**Appends the stack trace of i_throwable and all its chained cause exceptions
      ...
      class Msg.<br>
      See {@link Msg#printStackTrace(StringBuffer, Throwable)}
