...
/**Business rule exception (precondition violation) with parameters and internationalizable
  ...
  you can provide it just like to a {@link Failure}.
...
* }
  ...
  Such causal exceptions should be captured using a {@link Failure}.
...
public String getDefaultMessageTextPattern(){
    return Util.getDefaultMessageTextPattern(this, _defaultMessageTextPattern);
}
