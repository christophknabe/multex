package io.github.christophknabe.demo;  //SwingFile.java
...
import io.github.christophknabe.multex.core.Swing;
  ...
  public void actionPerformed(final java.awt.event.ActionEvent i_event){
    ...
    try{
      ...
      if(eventSource==_copyButton){
        ...
        throw new Failure("Wrong button", (Throwable)null, eventSource);
      }
        ...
        Swing.report(_frame, ex, (java.util.ResourceBundle)null);
        return;
      }
    //end try
  }//actionPerformed
