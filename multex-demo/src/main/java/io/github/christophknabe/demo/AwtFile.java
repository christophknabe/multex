package io.github.christophknabe.demo;  //AwtFile.java

import io.github.christophknabe.multex.core.AwtExceptionHandler;
...
public class AwtFile implements java.awt.event.ActionListener {
  ...
  private AwtFile(){
    MsgText.setInternationalization(true);
    ...
    //Behaviour:
    //One central exception handler for all user-triggered exceptions
    final Thread.UncaughtExceptionHandler exceptionHandler = new AwtExceptionHandler(_frame);
    ...
    public void actionPerformed(final java.awt.event.ActionEvent i_event){
        ...
        //try{
          ...
          if(eventSource==_copyButton){
            ...
            throw new Failure("Wrong button", null, eventSource);
          }
        /*}
